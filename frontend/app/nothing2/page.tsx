...
import dataTableData from "../dashboardcopy/data.json";
...
function LayeredCarouselSection() {
  ...
  return (
    <section className="relative z-10 space-y-6 rounded-[32px] bg-transparent px-4 py-8 text-[color:var(--hero-foreground)] lg:px-8 lg:py-10">
    ...
    <SidebarProvider style={sidebarLayoutStyles}>
      ...
      <SidebarInset>
        <div className={`${anton.variable} ${manrope.variable}`}>
          ...
          <div
            style={heroColors}
            className="relative flex flex-1 flex-col px-4 py-6 sm:px-6 lg:px-8"
          >
            <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(var(--hero-grid)_1px,transparent_1px),linear-gradient(90deg,var(--hero-grid)_1px,transparent_1px)] bg-[size:60px_60px] bg-[position:1rem_0] sm:bg-[position:1.5rem_0] lg:bg-[position:2rem_0]" />

            <section className="relative z-10 grid gap-10 rounded-3xl bg-transparent px-4 py-8 text-[color:var(--hero-foreground)] lg:grid-cols-[minmax(0,1.2fr)_auto] lg:items-center lg:px-8 lg:py-10">
            ...
            <section className="mt-8 rounded-3xl bg-transparent text-[color:var(--hero-foreground)]">
              <div className="mb-5 flex flex-col items-center text-center gap-2">
                <h2 className="text-2xl font-semibold sm:text-3xl">
                  Danh sách tài liệu
                </h2>
                <div className="h-1 w-16 rounded-full bg-[color:var(--primary)]/70" />
              </div>
              <div className="@container/main rounded-3xl bg-transparent p-3 sm:p-4 md:px-3">
                <DataTable data={dataTableData as any} hideLink />
              </div>
            </section>
          </div>
        </div>
